...
class CustomItemDelegate(QStyledItemDelegate):
    """A custom delegate to manually draw tree items for complete control."""
    def __init__(self, parent, theme):
        super().__init__(parent)
        self.theme = theme

    def sizeHint(self, option, index):
        """Provides a larger size hint for items to add vertical padding."""
    ...
    def paint(self, painter, option, index):
        ...
        if icon:
            ...
            # --- MODIFICATION: Create a new QRect for painting the icon correctly ---
            paint_rect = icon_rect.adjusted(0, 0, 0, 0) # Create a copy
...
class DocumentTreeWidget(QTreeWidget):
    ...
    def contextMenuEvent(self, event):
        ...
        refresh_action.triggered.connect(self.parent_panel.rescan_needed.emit)
...
class ChapterPanel(QWidget):
    ...
    def get_current_directory(self):
        """Determines the currently active directory based on the user's selection."""
        ...
        if dialog.exec() == QDialog.DialogCode.Accepted:
            ...
            if name:
                ...
                try:
                    ...
                    self.rescan_needed.emit()
                    QTimer.singleShot(100, lambda: self.app.load_document(filename))
            ...
            if new_name and new_name != old_name_no_ext:
                ...
                try:
                    ...
                    if is_renaming_current_file:
                        QTimer.singleShot(100, lambda: self.app.load_document(new_path))
